...
from ...models.body_text_summarization_summarize_post import BodyTextSummarizationSummarizePost
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/text_summarization/summarize",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code > 400:
        ...
        response_422 = HTTPValidationError.from_dict(dict_error)
        return ValidationError(loc=["body"], msg=response_422.detail, type_="value_error")
