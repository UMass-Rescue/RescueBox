...
async def create_input_form(task_schema: TaskSchema, endpoint: str, initial_values: Optional[Dict] = None, on_submit: callable = None, on_cancel: callable = None, container: Optional[ui.element] = None):
    """
    ...
    with form_card:
        ...
        async def handle_submit(form_data: dict):
            ...
            if not isinstance(validated, RequestBody):
                ...
                return await on_submit(validated, endpoint, task_schema, form_element=form_card)
