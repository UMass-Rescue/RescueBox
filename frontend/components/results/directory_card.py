            ...
            with ui.card().classes('bg-blue-50 border border-blue-300 p-4'):
                with ui.column().classes('gap-2'):
                    ...
                    try:
                        ...
                        ui.label(f'{len(files)} files').classes('text-sm text-gray-600')
                        if files:
                            ...
                            ui.label('Directory is empty').classes('text-sm text-gray-500 mt-2')
                ...
                # Open folder button
                if dir_path:
                    ui.button('Open Folder', on_click=lambda p=dir_path: ui.navigate.to(p)).classes('bg-blue-600 text-white mt-2')
