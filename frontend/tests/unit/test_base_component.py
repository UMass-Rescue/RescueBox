...
class TestBaseComponent:
    ...
    def test_log_action(self, mock_get_logger):
        ...
        assert any("test_action" in str(call) for call in mock_logger.info.call_args_list)
        assert any("{'detail': 'value'}" in str(call) for call in mock_logger.info.call_args_list)
