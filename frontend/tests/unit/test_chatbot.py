...
async def test_handle_new_conversation_resets_state_and_enables_input():
    ...
    with patch('frontend.pages.chatbot.ChatbotCore'), \
         patch('frontend.pages.chatbot.MessageHandler'), \
         patch('frontend.pages.chatbot.ToolRegistry'), \
         patch('frontend.pages.chatbot.ChatbotStateManager'), \
         patch('frontend.pages.chatbot.MessageFlowCoordinator'):
