...
TEST_CASES = [
    {
        ...
        "inputs": {"input_dir": {"path": str(DEMO_ROOT / "transcribe-audio" / "inputs")}},
        "parameters": {}
    },
    {
        "name": "2. Age and Gender",
        "endpoint": "/age-gender/predict",
        "inputs": {"image_directory": {"path": str(DEMO_ROOT / "age-gender-classifier" / "inputs")}},
        "parameters": {}
    },
    {
    ...
    },
    {
        ...
        "inputs": {
            "query_directory": {"path": str(DEMO_ROOT / "face-detect" / "find_face_inputs")}
        },
        "parameters": {
            "collection_name": "e2e_test_collection",
    ...
    },
    {
        ...
        "inputs": {
            "ufdr_file": {"path": str(DEMO_ROOT / "ufdr-mount" / "inputs" / "test.ufdr")},
