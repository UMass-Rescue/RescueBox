...
def detect_deepfake(
    ...
    video_paths: str = typer.Argument(
        ..., help="The path to input video files eg: path/to/your/video.folder"
    ),
    model_path: str = typer.Argument(
        ..., help="The path to the pre-trained model eg: path/to/your/model.pth"
    ),
    output_path: str = typer.Argument(
        ..., help="The path Directory to save processed videos"
    ),
    cuda_flag: str = Annotated[bool, typer.Option("-cuda", help="cuda flag boolean")]
    == "True",
) -> str:
    evaluator = VideoEvaluator(
        model_path=model_path, output_path=output_path, cuda=cuda_flag
    )
